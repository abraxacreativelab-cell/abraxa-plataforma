/**
 * @abraxa/agents — Motor de agentes: router de proveedores, tools, usage_ledger y presupuesto
 *
 * Carril de H3. H1 dejó el paquete creado, cableado a apps/api y con sus
 * dependencias instaladas: no hay que editar nada fuera de esta carpeta.
 *
 * Al construir:
 *   1. Cuelga tus rutas de este `router`. apps/api ya lo monta en /agents.
