/**
 * @abraxa/flows — Automatizaciones: motor, catalogo de nodos y asistente en espanol
 *
 * Carril de H8. H1 dejó el paquete creado, cableado a apps/api y con sus
 * dependencias instaladas: no hay que editar nada fuera de esta carpeta.
 *
 * Al construir:
 *   1. Cuelga tus rutas de este `router`. apps/api ya lo monta en /flows.
